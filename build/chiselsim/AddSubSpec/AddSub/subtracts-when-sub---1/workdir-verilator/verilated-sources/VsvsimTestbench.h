...
class alignas(VL_CACHE_LINE_BYTES) VsvsimTestbench VL_NOT_FINAL : public VerilatedModel {
    friend class VsvsimTestbench__Syms;
  private:
  ...
  public:
    ...
    static void getBitWidthImpl_sub(int* value);
    ...
    static void getBitsImpl_sub(svBitVecVal* value_sub);
    static void setBitsImpl_a(const svBitVecVal* value_a);
    static void setBitsImpl_b(const svBitVecVal* value_b);
    static void setBitsImpl_sub(const svBitVecVal* value_sub);
